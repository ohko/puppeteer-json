...
export type CmdExistsSelector = CmdBase & { Cmd: CmdTypes.ExistsSelector, Options?: { timeout: number } } & CmdSelector & CmdJson
export type CmdNotExistsSelector = CmdBase & { Cmd: CmdTypes.NotExistsSelector, Options?: { timeout: number } } & CmdSelector & CmdJson
export type CmdLoop = CmdBase & { Cmd: CmdTypes.Loop } & CmdKey & CmdJson
...
export type CmdSub = CmdBase & { Cmd: CmdTypes.Sub } & CmdValue & CmdJson
export type CmdCall = CmdBase & { Cmd: CmdTypes.Call } & CmdValue
export type CmdIf = CmdBase & { Cmd: CmdTypes.If } & CmdSyncEval & CmdJson
export type CmdFinally = CmdBase & { Cmd: CmdTypes.Finally } & CmdJson
