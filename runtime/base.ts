...
export type CmdScreenshot = { Cmd: CmdTypes.Screenshot, Value?: string, Options?: puppeteer.Base64ScreenShotOptions, Selector?: string } & CmdBase & CmdIndex
...
export type CmdExistsSelector = { Cmd: CmdTypes.ExistsSelector, Options?: { timeout: number } } & CmdBase & CmdSelector & CmdJson & CmdElseJson
export type CmdNotExistsSelector = { Cmd: CmdTypes.NotExistsSelector, Options?: { timeout: number } } & CmdBase & CmdSelector & CmdJson & CmdElseJson
export type CmdLoop = { Cmd: CmdTypes.Loop } & CmdBase & CmdKey & CmdJson
export type CmdTry = { Cmd: CmdTypes.Try, Catch?: ICmd[] } & CmdBase & CmdKey & CmdJson
